  ...
  >
    <Transition appear name="fade-slow">
      <div v-show="mounted" class="h-full">
          ...
          <div class="container-wrapper lg:pl-[17rem]">
            ...
            >
              <div class="flex items-center gap-2 sm:gap-4">
                <span
                  class="i-ph-star-fill h-6 w-6 text-[#FFB802] lg:h-8 lg:w-8"
                />
        ...
        <div
          class="container-wrapper absolute bottom-32 left-1/2 w-full transform px-4 md:bottom-24 -translate-x-1/2 lg:-bottom-1/5"
        >
        ...
        >
          <span
            class="mb-1.5 inline-block text-sm text-[#FF0000] font-medium uppercase"
            >Overview</span
          >
          <p
            class="line-clamp-3 text-sm text-black leading-relaxed lg:line-clamp-2 xl:line-clamp-3"
          >
            {{ item.overview }}
          </p>
        </div>
